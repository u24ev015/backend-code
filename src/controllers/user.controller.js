...
const registerUser= asyncHandler(async(req,res)=>{
  ...
  //validation- check wether empty or not
  //check if user alreay exists:username email 
  //check for images 
  //upload them to cloudinary
  //create user object'create entry in db
  //remove pass and refresh token field from resposne
...
const loginUser = asyncHandler(async (req,res)=>{
  //take information from the frontend
  //check username and email
  //find wether user exist or not or same with email
  //check password
...
const logoutUser = asyncHandler(async (req,res)=>{
  await User.findByIdAndUpdate(req.user._id,{
    $unset:{
      refreshToken:1 // this removes field from this document
    }
  },
    {
      new:true
